// File ini berfungsi untuk MEMVALIDASI form registrasi
// Di file ini kita bisa kasih peraturan untuk setiap value text box kita. 
// Namanya biasanya harus sama, makanya paling gampang kita samain seperti interface kita.
